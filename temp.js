...
function riddle(riddle_text, riddle_answer){
...
function calc_damage(attack, defence, text1, text2, text3, text4, text5, text6){
...
function calc_opponent_health (health, attack, defence){
    return (health - calc_damage(attack, defence, "You ", "", "Your attack deals ", " damage to the opponent", "are", "your"))
}

function calc_hero_health (health, attack, defence) {
    return (health - calc_damage(attack, defence, "The enemy ", "s", "The enemy attack deals ", " damage to you.", "is", "their"))
}
function  ight(hero_health, hero_attack, hero_defence, opponent_health, opponent_attack, opponent_defence){
    both_alive = true
